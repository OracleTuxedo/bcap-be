...
public class SED03F107RModule {
    private static final Logger logger = LogManager.getLogger(SAC02F452RService.class);

    private final ServiceSupport serviceSupport;

    public SED03F107RModule(ServiceSupport serviceSupport) {
    ...
    public TelegramOutputUserData call(HttpServletRequest request, SED03F107RInVo inVo){
        ...
        try {
            TelegramInputUserData inputUserData = serviceSupport.tuxedoHeader(request, "SED03F107", "WAC070100H");
